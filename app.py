...
# ---------- Define feature schema (MUST MATCH TRAINING ORDER) ----------
FEATURES = [
...
def sidebar_inputs():
    ...
    vals["sky-cover"] = st.sidebar.number_input("sky-cover (0–100 or categorical scale)", min_value=0, max_value=100, value=20, step=1)
...
st.subheader("Enter values and click Predict")
